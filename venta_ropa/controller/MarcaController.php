...
class MarcaController extends SecuredController
{
  ...
  function Home(){
      ...
      $this->view->Mostrar($this->Titulo, $Marcas,$this->IsUserLogged(),$this->EsAdmin());
  }

  function agregarMarca(){
    $this->view->MostrarAgregarMarca("Agregar Marca",$this->IsUserLogged(),$this->EsAdmin());
  }

  function EditarMarca($param){
      $id_marca = $param[0];
      $Marca = $this->model->GetMarca($id_marca);
      $this->view->MostrarEditarMarca("Editar Marca", $Marca,$this->IsUserLogged(),$this->EsAdmin());
  }
